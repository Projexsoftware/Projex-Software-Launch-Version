...
class Templates extends CI_Controller {
	 ...
	 */
        ...
        public function __construct() {
             ...
             $this->load->model("mod_supplierz_buildz");
	...
	public function index()
	{
        ...
        $data['templates'] = $this->mod_common->get_all_records("project_buildz_templates", "*", 0, 0, array("company_id" =>  $this->session->userdata("company_id")));
        $this->stencil->title('Buildz Templates');
	    $this->stencil->paint('supplierz_buildz/templates/manage_templates', $data);
	}

	public function add_template() {
	    $this->mod_common->is_company_page_accessible(163);
        $this->stencil->title('Add Template');
        $this->stencil->paint('supplierz_buildz/templates/add_template');
    }
    
    public function view_template() {
        $this->stencil->title('View Buildz Template');
        $this->stencil->paint('supplierz_buildz/templates/view_template');
    }
	 ...
	 public function add_new_template_process() {
	   ...
	   {
            $this->stencil->title('Add Buildz Template');
            $this->stencil->paint('supplierz_buildz/templates/add_template');
		}
		else{
			$table = "project_buildz_templates";
			...
			if ($add_new_template) {
				...
				redirect(SURL . 'supplierz_buildz/templates');
			} else {
	...
	if($template_id=="" || !(is_numeric($template_id))){
        ...
        $table = "project_buildz_template_items";
        $data['template_stages'] = $this->mod_supplierz_buildz->get_template_stages($template_id);
        ...
        $data['template_edit'] = $this->mod_common->select_single_records($table, $where);
         ...
         $data["extsupplierzbuildztemplates"] = $this->mod_supplierz_buildz->get_existing_supplierz_buildz_templates();

        if (count($data['template_edit']) == 0) {
            redirect("nopage");
        } else {
        $this->stencil->title('Edit Buildz Template');
        $this->stencil->paint('supplierz_buildz/templates/view_template', $data);
        }
    }
    ...
    public function add_new_template_item() {
	    ...
	    if ($this->form_validation->run() == FALSE)
			...
			$stage_id = $this->input->post('stage_id');
		           ...
		           $this->mod_common->insert_into_table("project_buildz_tasks", $ins_array);
    ...
    public function get_template_items(){ 
       ...
       $table = "project_buildz_template_items";
       $data['template_stages'] = $this->mod_supplierz_buildz->get_template_stages($template_id);
       $this->load->view("supplierz_buildz/templates/template_items", $data);
    }
    ...
    public function get_stage_status(){
       ...
       $this->load->view("supplierz_buildz/templates/stage_status_ajax", $data);
    }
	...
	$table = "project_buildz_templates";
     ...
     $table = "project_buildz_template_item_checklists";
     $where = "`template_id` ='" . $id . "'";
     ...
     $table = "project_buildz_template_item_notes";
     $where = "`template_id` ='" . $id . "'";
     ...
     $table = "project_buildz_template_item_reminders";
     $where = "`template_id` ='" . $id . "'";
     ...
     $table = "project_buildz_template_item_files";
     $where = "`template_id` ='" . $id . "'";
    ...
    public function add_new_checklist(){
     ...
     $checklist_item_info = $this->mod_common->select_single_records($table, $where);
                              ...
                              $data['template_id'] = $checklist_item_info['template_id'];
                               $this->load->view("supplierz_buildz/templates/checklist", $data);
                        }
    ...
    public function add_new_note(){
      $table = "project_buildz_template_item_notes";
			...
			$item_id = $this->input->post('note_item_id');
                        ...
                        $data['template_id'] = $template_id;
                        $task_info = $this->mod_common->select_single_records("project_buildz_template_items", "`id` ='" . $item_id . "'");
			...
			if ($add_new_note) {
                              ...
                              $this->load->view("supplierz_buildz/templates/notes", $data);
                        }
    ...
    public function remove_note(){
     ...
     $task_info = $this->mod_common->select_single_records("project_buildz_template_items", "`id` ='" . $note_info['item_id'] . "'");
     $data['task_id'] = $task_info['task_id'];
    ...
    public function remove_checklist(){
     ...
     $total_checklists = $this->mod_common->get_all_records("project_buildz_template_item_checklists", '*', 0, 0, array("item_id"=> $checklist_info['item_id']));
                                foreach($checklists as $val){
                                  if($val['checklist']!=""){
                                    $ck = explode(",", $val['checklist']);
...
$total_checklists = $this->mod_common->get_all_records("project_buildz_template_item_checklists", '*', 0, 0, array("item_id"=> $checklist_info['item_id'], "id !="=>$id));
...
$this->mod_common->update_table($table, array("id"=>$val['id']), array("status"=>$status));
    ...
    public function upload_file(){
       ...
       if (isset($_FILES['task_file']['name']) && $_FILES['task_file']['name'] != "") {
						...
						$templates_folder_path = './assets/supplierz_buildz/template_task_uploads/files';
						$templates_folder_path_main = './assets/supplierz_buildz/template_task_uploads/files/';
    ...
    $this->mod_common->insert_into_table("project_buildz_template_item_files", $ins_array);
    $this->load->view("supplierz_buildz/templates/files", $data);
    ...
    public function remove_file(){
     ...
     $file_name="./assets/supplierz_buildz/template_task_uploads/files/".$file_info['file'];
	...
	unlink($file_name);
     ...
     $task_info = $this->mod_common->select_single_records("project_buildz_template_items", "`id` ='" . $file_info['item_id'] . "'");
     $data['task_id'] = $task_info['task_id'];
    ...
    public function upload_image(){
       ...
       if (isset($_FILES['task_image']['name']) && $_FILES['task_image']['name'] != "") {
						...
						$templates_folder_path = './assets/supplierz_buildz/template_task_uploads/images';
						$templates_folder_path_main = './assets/supplierz_buildz/template_task_uploads/images/';
    ...
    $this->mod_common->insert_into_table("project_buildz_template_item_files", $ins_array);
    $this->load->view("supplierz_buildz/templates/images", $data);
    ...
    public function remove_image(){
     ...
     $file_name="./assets/supplierz_buildz/template_task_uploads/images/".$file_info['file'];
    ...
    public function add_new_reminder(){
      $table = "project_buildz_template_item_reminders";
			...
			$message = $this->input->post('message');
		           ...
		           $this->mod_common->insert_into_table("project_buildz_reminder_users", $ins_array);
			...
			if ($add_new_reminder) {
                              ...
                              $this->load->view("supplierz_buildz/templates/reminders", $data);
                        }
    ...
    public function available_for_import_by_user(){
        $id = $this->input->post("id");
        $available_for_import_by_user = $this->input->post("available_for_import_by_user");
        $this->mod_common->update_table("project_buildz_templates", array("id" => $id), array("available_for_import_by_user" => $available_for_import_by_user));
    }
