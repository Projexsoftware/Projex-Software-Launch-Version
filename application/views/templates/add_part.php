...
<input  name="component_type[<?php echo $count;?>]" rno ="<?php echo $count;?>" id="component_type<?php echo $count;?>" type="hidden"  class="form-control" value="0" />
                                                           ...
                                                           <td>
                                                               <input class="form-control part-form-control" type="text" name="part_name[<?php echo $count?>]" id="partfield<?php echo $count?>" required="true" value=""/>
                                                           </td>
                                                           <td>
                                                           ...
                                                           <td>
                                                               <input class="form-control" type="number" name="manualqty[<?php echo $count?>]" id="manualqty<?php echo $count?>" required="true" value=""/>
                                                           </td>
                                                           <td class="text-right">
