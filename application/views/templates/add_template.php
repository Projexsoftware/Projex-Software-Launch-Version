    ...
    <form id="TemplateForm" method="POST" action="<?php echo SURL ?>setup/add_new_template_process" autocomplete="off">
        <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                                    ...
                                                    <div class="form-group label-floating">
                                                       ...
                                                       <div class="table-responsive">
                                                             <table id="partstable" class="table sortable_table templates_table">
                                                               ...
                                                               <tbody>
                                                                    <tr id="trnumber0" rno="0" tr_val="0" class="defaultItem">
                                                                     <input  name="component_type[0]" rno ="0" id="component_type0" type="hidden"  class="form-control" value="0" />
                                                                       <td>
                                                                           <select data-container="body" class="selectStage" data-style="btn btn-warning btn-round" title="Choose Stage" data-size="7" name="stage_id[0]" id="stagefield0" required="true">
                                                                                <option disabled> Choose Stage</option>
                                                                            </select>
                                                                       </td>
                                                                       <td>
                                                                           <input class="form-control part-form-control" type="text" name="part_name[0]" id="partfield0" required="true" value=""/>
                                                                       </td>
                                                                       <td>
                                                                           <select rno="0" data-container="body" class="selectComponent" data-style="btn btn-warning btn-round" title="Choose Component" data-live-search="true" data-size="7" name="component_id[0]" id="componentfield0" required="true" onchange="return componentval(this);">
                                                                       ...
                                                                       <td>
                                                                            <input type="text" class="form-control" name="supplier_name[0]" id="supplierfieldname0" rno ='0' value="" readonly required="true">
                                                                            <input type="hidden" class="form-control" name="supplier_id[]" id="supplierfield0" rno ='0' value="0" readonly>
                                                                       </td>
                                                                       <td>
                                            ...
                                            <div class="card-content">
                                                 <div class="form-footer">
                                                     ...
                                                     <div class="pull-right">
                                                        <a href="<?php echo SURL;?>templates" class="btn btn-default btn-fill">Close</a>
                                                  </div>
                                                 </div>
                                             </div>
                                        </div>
