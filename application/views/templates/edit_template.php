        <?php if(in_array(86, $this->session->userdata("permissions"))) {?>
                            <div class="card">
                                     ...
                                     <div class="panel-group" id="accordionTemplate" role="tablist" aria-multiselectable="true">
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseOneTemplate" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOneTemplate">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-12">
                                                        <select class="selectpicker" data-live-search="true" data-style="btn btn-warning btn-round" title="Import Supplierz Template" id="suptemplate_id" name="suptemplate_id" onchange="getTemplatingbySupplierzTemplate(this.value)">                 
                                                        <?php if(count($supplierzTemplates)>0){ foreach($supplierzTemplates as $tem){ 
                                                        $is_component_missing = check_missing_component($tem->template_id);
                                                        ?>                                       
                                                        <option value="<?php echo $tem->template_id;?>" <?php echo $is_component_missing ? 'disabled' : ''; ?>><?php echo $tem->template_name;?> - <?php echo $tem->template_desc;?></option>
                                                        <?php } }?>
                                                        </select>
                                                    </div>
                                                <div class="col-lg-3 col-md-3 col-sm-12">
                                                        <select class="selectpicker" data-style="btn btn-warning btn-round" data-live-search="true" title="Select From Project" id="extproject_id" name="extproject_id" onchange="getTemplatingbyProject(this.value)">                 
                        ...
                        <?php } ?>   
           <form id="TemplateForm" method="POST" action="<?php echo SURL ?>setup/update_template_process">
                   <input type="hidden" id="template_id" name="template_id" value="<?php echo $template_edit[0]->template_id;?>">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" type="text" name="template_name" id="template_name" required="true" uniqueEditTemplate="true" value="<?php echo $template_edit[0]->template_name;?>"/>
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <textarea class="form-control" type="text" name="template_desc" id="template_desc" required="true"><?php echo $template_edit[0]->template_desc;?></textarea>
				                    	...
				                    	<div class="form-group label-floating">
                								<select class="selectpicker" data-style="select-with-transition" title="Status *" data-size="7" name="template_status" id="template_status" required="true">
                									...
                									<option value="1" <?php if( $template_edit[0]->template_status==1){ ?> selected <?php } ?>>Current</option>
                									<option value="0" <?php if( $template_edit[0]->template_status==0){ ?> selected <?php } ?>>Inactive</option>
                                                </select>
                                        </div>
                                        <div class="loader">
                                            <center>
                                                 ...
                                                 <table id="partstable" class="table sortable_table templates_table">
                                                   ...
                                                   <tbody>
                                                        ...
                                                        <tr id="trnumber<?php echo $count?>" tr_val="<?php echo $count ?>">
                                                           ...
                                                           <td>
                                                                <input type="text" class="form-control" name="supplier_name[<?php echo $count; ?>]" id="supplierfieldname<?php echo $count ?>" rno ='<?php echo $count ?>' value="<?php echo $val->supplier_name;?>" readonly required="true">
                            ...
                            <div class="card">
                                <div class="card-content">
                                     <div class="form-footer">
                                         <div class="pull-left">
                                            <?php if(in_array(86, $this->session->userdata("permissions"))) {?>
                                            <button type="submit" class="btn btn-warning btn-fill">Update Template</button>
                                            <?php } ?>
                                         </div>
                                         <div class="pull-right">
                                            <a href="<?php echo SURL;?>setup/templates" class="btn btn-default btn-fill">Close</a>
                                      </div>
                                     </div>
                                 </div>
                            </div>
