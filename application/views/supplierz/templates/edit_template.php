                                            ...
                                            <div id="collapseOneTemplate" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOneTemplate">
                                                <div class="panel-body">
                                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                                        <select class="selectpicker" data-live-search="true" data-style="btn btn-warning btn-round" title="Choose Existing Project Costing" id="extcosting_id" name="extcosting_id" onchange="
                                                    getTemplateByProjectCosting(this.value)">                 
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                                        <select class="selectpicker" data-style="btn btn-warning btn-round" title="Choose Existing Template" id="exttemplate_id" name="exttemplate_id" onchange="getTemplatingbyTemplate(this.value)">                 
            ...
            <?php } ?>
           <form id="TemplateForm" method="POST" action="<?php echo SURL ?>supplierz/update_template_process" autocomplete="off">
