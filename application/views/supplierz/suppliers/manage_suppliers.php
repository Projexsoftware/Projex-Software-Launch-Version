                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="toolbar">
                                        <?php if(in_array(160, $this->session->userdata("permissions"))) {?>
                                        <a href="<?php echo SURL;?>supplierz/add_supplier" class="btn btn-info"><i class="material-icons">add</i> Add Supplier</a>
                                        <?php }
									...
									<?php } ?></td>
                                                    <td class="text-right">
                                                        <?php if(in_array(160, $this->session->userdata("permissions"))) {?>
                                                        <a href="<?php echo SURL;?>supplierz/edit_supplier/<?php echo $val['supplier_id'];?>" class="btn btn-simple btn-warning btn-icon edit"><i class="material-icons">edit</i></a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                                <?php 
