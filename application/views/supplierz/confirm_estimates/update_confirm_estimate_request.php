    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-content">
                <h4 class="card-title">Update Confirm Estimate</h4>
           <table class="table" width="500px">
                    							
                    							    <tbody>
                    								<tr>
                    								    <td style="width:180px;"><b>Created Date : </b></td>
                    									<td><?php echo date("d/m/Y", strtotime($confirm_estimate_details[0]->created_at));?></td>
                    								</tr>
                    								<tr>
                    								    <td style="width:180px;"><b>Status : </b></td>
                    									<td><?php if($confirm_estimate_details[0]->status==1){ echo '<span class="label label-success">Sent</span>';} else{ echo '<span class="label label-danger">Returned</span>'; };?></td>
                    								</tr>
                    								</tbody>
            </table>
                ...
                ?>
                    ...
                    <table class="table">
                    						            ...
                    						            <tr>
                    						                ...
                    						                <td  class="text-right">
                    						                        <a class="btn btn-icon btn-simple btn-download btn-success" href="<?php echo SURL.'supplierz/download/'.$document['id'];?>"><i title="Download" class="material-icons">download</i></a>
    ...
    <div class="col-md-12">
         <div class="card">
            ...
            <div class="card-content">
                ...
                <form id="parts_form" method="post" action="<?php echo SURL . 'supplierz/return_and_confirm' ?>">
                              <input type="hidden" name="confirm_estimate_id" value="<?php echo $confirm_estimate_details[0]->id;?>">
                              <input type="hidden" name="company_name" value="<?php echo $company_info['com_name'];?>">
                                <table class="table table-no-bordered">
                                                ...
                                                foreach($confirm_estimate_details as $val){?>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td><textarea class="form-control" name="supplier_notes_<?php echo $val->confirm_estimate_part_id;?>"></textarea></td>
                                                    </tr>
                                                <?php $count++; } } ?>
                                                </tbody>
                                                </table>
