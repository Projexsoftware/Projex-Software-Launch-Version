            <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <form id="DesignzForm" method="POST" action="<?php echo SURL; ?>supplierz/edit_designz_process" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input class="form-control" type="text" name="project_name" id="project_name" required="true" uniqueEditProject="true" value="<?php echo $designz_edit['project_name'];?>"/>
                                            ...
                                            <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input class="form-control" type="text" name="floor_area" id="floor_area" required="true" digits="true" value="<?php echo $designz_edit['floor_area']; ?>"/>
                                            ...
                                            <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <textarea class="form-control" name="movies" id="movies" rows="7" cols="3"><?php echo $designz_edit['movies']; ?></textarea>
        				                        	</div>
                                            </div>
                                            <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <textarea class="form-control" name="3D" id="3D" rows="7" cols="3"><?php echo $designz_edit['3D']; ?></textarea>
        				                        	</div>
                                            </div>
                                            <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        <div class="form-footer text-right">
                                                            ...
                                                            <a href="<?php echo SURL;?>supplierz/manage_designz" class="btn btn-default btn-fill">Cancel</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
