<div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                    ...
                                    <form id="ComponentCSVForm" method="POST" action="<?php echo SURL ?>supplierz/add_component_from_csv" enctype="multipart/form-data">
                                    <div class="row">
                                    ...
                                    <form id="ComponentForm" method="POST" action="<?php echo SURL ?>supplierz/add_new_component_process" enctype="multipart/form-data">
                                        <div class="row">
                                        <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">
                                        ...
                                        <div class="col-md-12">
                                                <div class="checkbox">
                                                    <label>
                                                      <input type="checkbox" id="include_in_price_book" name="include_in_price_book" value="1"> Include in Price Book
                                                    </label>
                                                </div>
                                        </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="checkbox">
                                                    <label>
                                                        ...
                                                        <input type="checkbox" name="list_this_component_in_online_store" id="list_this_component_in_online_store" value="1">
                                                    </label>
                                                </div>
                                            </div>
                                        </div>-->
                                        <div class="col-md-12 online_store_fields_container hidden">
                                            <div class="form-group label-floating">
                                                    <label class="control-label">
                                                    Sale Price excluding GST ($)
                                                    <small>*</small>
                                                    </label>
                                                    <input class="form-control" type="text" name="sale_price" id="sale_price" required="true" value="<?php echo set_value('sale_price')?>"/>
