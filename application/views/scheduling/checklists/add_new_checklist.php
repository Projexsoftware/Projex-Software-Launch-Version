<div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <form id="ChecklistForm" method="POST" action="<?php echo SCURL ?>checklists/add_new_checklist_process">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="form-footer text-right">
                                            ...
                                            <a href="<?php echo SURL;?>buildz/checklists" class="btn btn-default btn-fill">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
