...
<?php 
  ...
  //}
?>
<?php $task_images = get_task_images($project_id, $item_id, $current_role);?>
                                      ...
                                      <?php if($current_role==1 || $current_role==2){ ?>
                                       <div class="togglebutton pull-left privacy_toggle" data-placement="bottom">
                                                <label class="text-default">
                                                  <input id="privacy_settings<?php echo $val['id'];?>" name="privacy_settings" type="checkbox" <?php if($val['privacy_settings']==0){ ?> checked <?php } ?> onclick="set_privacy(<?php echo $val['id'];?>, <?php echo $item_id;?>, 'Image');" >Private
                                                </label>
                                        </div>
                                       <?php } ?>
...
<input type="hidden" name="image_project_id" value="<?php echo $project_id;?>">
