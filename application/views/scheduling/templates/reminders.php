<?php $reminders = get_template_task_reminders($template_id, $item_id);?>
...
<h5 class="modal-title" id="myReminderModalLabel"><?php echo get_task_name($task_id);?> Notifications</h5>                                                        </div>
                                ...
                                <li class="timeline-inverted">
                                    ...
                                    <div class="timeline-panel">
                                        <a rowno="<?php echo $item_id;?>" id="<?php echo $reminder['id'];?>" class="remove_reminder btn btn-simple btn-danger btn-icon pull-right"><i class="material-icons">close</i></a>
...
<input type="hidden" id="reminder_task_id" name="reminder_task_id" value="0">
																...
																<input type="hidden" id="reminder_template_id" name="reminder_template_id" value="<?php echo $template_id;?>">
