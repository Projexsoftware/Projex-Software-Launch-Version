                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="templateName" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingtemplateName">
                                                <div class="panel-body">
                                                  <span class="editable" data-type="name" id="editable-name"><?php echo $template_edit['name'];?></span>
                                                </div>
                                            </div>
                                        </div>
									</div>
									<div class="panel-group col-md-6" id="accordion2" role="tablist" aria-multiselectable="true">
                                        <div class="panel panel-default">
                                            ...
                                            <div id="templateDescription" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTemplateDescription">
                                                <div class="panel-body">
                                                    <span class="editable" data-type="description" id="editable-description"><?php echo $template_edit['description'];?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                             ...
                                             <div class="panel-body">
                                               <div class="table-responsive table-<?php echo $val['stage_id'];?>">
                                                 <table id="table_<?php echo $val['stage_id'];?>" class="table sortable_table">
                                                   <tbody>
                                                      <?php 
                                                      $template_items = get_template_item_by_stage($val['stage_id'], $template_edit['id']);
                                                      $i=1;
                                             ...
                                             <div id="collapseOneTemplate" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOneTemplate">
                                                <div class="panel-body">
                                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                                        <select class="selectpicker import_template_from_project" data-style="btn btn-warning btn-round" data-live-search="true" title="Import From Project" id="import_project_id" name="import_project_id">                 
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                                        <select class="selectpicker import_template_from_template" data-live-search="true" data-style="btn btn-warning btn-round" title="Import From Existing Template" id="import_template_id" name="import_template_id">                 
