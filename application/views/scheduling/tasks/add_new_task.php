<div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <form id="TaskForm" method="POST" action="<?php echo SCURL ?>tasks/add_new_task_process">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="input_fields_wrap">
                                            ...
                                            <div class="form-group label-floating">
                                                ...
                                                <input class="form-control more_checklist" type="text" name="checklists[]" id="checklist1" required="true" uniqueChecklist="true" value="<?php echo set_value('checklists[]')?>"/>
                                                <?php echo form_error('checklists[]', '<div class="custom_error">', '</div>'); ?>
    					                    </div>
                                        </div>					
                                        <div class="form-footer text-right">
                                            <button type="submit" class="btn btn-warning btn-fill">Add</button>
                                            <a href="<?php echo SURL;?>buildz/tasks" class="btn btn-default btn-fill">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
