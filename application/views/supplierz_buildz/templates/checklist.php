<?php $checklists = get_buildz_template_task_checklist($template_id, $item_id);?>
<?php if($checklist_items!=""){$task_checklist = explode(",", $checklist_items);}else{ $task_checklist = array();} ?>
<a class="btn btn-primary btn-round add_checklist_btn<?php echo $item_id;?>" data-toggle="modal" data-target="#addChecklistModal<?php echo $item_id;?>">Checklist <span class="badge count<?php echo $item_id;?> count<?php echo $item_id;?>"><?php echo count($task_checklist);?></span>
<b class="caret"></b></a>
                                        <!-- Checklist modal -->
...
<h5 class="modal-title" id="myChecklistModalLabel"><?php echo get_buildz_task_name($task_id);?> Checklist</h5>                                                        </div>
