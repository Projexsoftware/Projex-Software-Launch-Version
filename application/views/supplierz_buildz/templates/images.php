...
<?php $task_images = get_buildz_template_task_images($template_id, $item_id);?>
...
<h5 class="modal-title" id="myImageModalLabel"><?php echo get_buildz_task_name($task_id);?> Images</h5>                                                        </div>
