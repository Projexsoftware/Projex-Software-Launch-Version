...
<?php $task_images = get_buildz_template_task_images($item['template_id'], $item['id']);?>
...
<h5 class="modal-title" id="myImageModalLabel"><?php echo get_buildz_task_name($item['task_id']);?> Images</h5>                                                        </div>
                                ...
                                <div class="card-image" data-header-animation="true">
                                       <a href="#pablo">
                                            <img class="img" src="<?php echo BUILDZ_TEMPLATE_TASK_PATH.'images/'.$val['file'];?>">
                                       </a>
                                </div>
                                <div class="card-content">
                                    <div class="card-actions">
                                       <a rel="tooltip" data-placement="bottom" title="Download" class="btn btn-success btn-simple btn-icon" href="<?php echo SURL;?>supplierz_buildz/templates/download_image/<?php echo $val['file'];?>"><i class="material-icons">file_download</i></a>
...
<input type="hidden" name="image_template_id" value="<?php echo $item['template_id'];?>">
