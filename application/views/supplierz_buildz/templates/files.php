...
<?php $task_files = get_buildz_template_task_files($template_id, $item_id);?>
...
<h5 class="modal-title" id="myFileModalLabel"><?php echo get_buildz_task_name($task_id);?> Files</h5>                                                        </div>
