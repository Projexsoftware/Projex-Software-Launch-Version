                            ...
                            <div class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <ul class="nav nav-pills nav-pills-warning">
                                            ...
                                            <li class="active"><a href="#specificationOptions" data-toggle="tab">Specifications</a></li>
                                    	...
                                    	<div class="tab-content">
                                    	    <div class="tab-pane active" id="specificationOptions">
                                                <div class="form-group label-floating">
                                                    <?php $count = 0;
				        	...
				        	if ($prjprt->stage_id == $stage['stage_id']) { 
							  ...
							  if($prjprt->hide_from_boom_mobile){
							     $no_of_checkboxes++; 
                                        		...
                                        		<input type="hidden" id="selected_tab" name="selected_tab" value="specifications">
                                ...
                                <div class="card-content">
                                     <div class="form-footer">
                                         ...
                                         <div class="pull-right">
                                             ...
                                             <a href="<?php echo SURL;?>project_costing/report/specifications/<?php echo $project_id;?>" class="btn btn-warning btn-fill">Report</a>
                                            <?php } ?>
