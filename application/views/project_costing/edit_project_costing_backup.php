                                                    ...
                                                    <table class="table">
                                                      <tbody>
                                                          ...
                                                          <tr>
                                                            <td >Project Subtotal</td>
                                                            <td>$</td>
                                                            <td width="160"><input class="form-control" name="total_cost_with_overhead" id="total_cost_with_overhead" value="<?php echo number_format($overhead_total_cost, 2, '.', ''); ?>" readonly></td>
                                                          </tr>
                                                          <tr>
                                                            <td>Profit Margin</td>
                                                            <td>%</td>
                                                            <td width="160"><input class="form-control cal-on-change" name="profit_margin" id="profit_margin" value="<?php echo number_format($pc_detail->porfit_margin, 2, '.', ''); ?>" readonly></td>
                                                          </tr>
                                                          <tr>
                                                            <td>Project Subtotal</td>
                                                            <td>$</td>
                                                          ...
                                                          <tr>
                                                            <td>Tax</td>
                                                            <td>%</td>
                                                            <td width="160"><input class="form-control cal-on-change" name="costing_tax" id="costing_tax" value="<?php echo get_company_tax();?>" readonly></td>
                                                          </tr>
                                                          <tr>
                                                            <td >Project Subtotal</td>
                                                            <td>$</td>
