                    ...
                    <?php if($this->session->userdata("admin_role_id")!=3){ ?>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <h3>What's New &nbsp;&nbsp;<a href="<?php echo SURL;?>whats_new" class="btn btn-rose btn-round btn-sm">See All</a></h3>
    ...
    <ul class="timeline timeline-simple" style="margin-left:10px;">
                                <?php if(count($activities)>0){
                                 ...
                                 foreach($activities as $val){ 
                                  ...
                                  $project_role = get_user_project_role($val['project_id'], $this->session->userdata("admin_id"));
                                 ...
                                 if((($current_role==1 || $current_role==2) || ($current_role>2 && $is_activity_public==1 && $activity_type[1]!="reminder")) && $counter<3){
                                 $counter++;
                                 $class_name = "success";
...
<?php 
                    ...
                    <h3>Latest Projects&nbsp;&nbsp;<a href="<?php echo SURL;?>projects" class="btn btn-rose btn-round btn-sm">View All</a></h3>
                    <br>
                    <div class="row">
                            ...
                            <div class="card card-product">
                                ...
                                <div class="card-content">
                                    <div class="card-actions">
                                        ...
                                        <a href="<?php echo SURL;?>projects/edit_project/<?php echo $val['id'];?>"><button type="button" class="btn btn-default btn-simple" rel="tooltip" data-placement="bottom" title="View">
                                            <i class="material-icons">art_track</i>
                                        </button></a>
                                    </div>
                                    <h4 class="card-title">
                                        <a href="<?php echo SURL;?>projects/edit_project/<?php echo $val['id'];?>"><?php echo $val['name'];?></a>
                                    </h4>
