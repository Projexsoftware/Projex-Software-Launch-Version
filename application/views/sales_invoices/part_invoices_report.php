...
<?php endforeach; ?>
    ...
    <tr class="imth">
        <th style="background-color:#C0B9B9!important;padding:8px!important; color:#000000!important;" colspan="6" >TOTAL ALLOWANCE ADJUSTMENTS</th>
        <th style="background-color:#C0B9B9!important;padding:8px!important; color:#000000!important;" class="text-right"><?php
            echo "$";
        ?><?=  number_format(abs($total_invoice_amount),2, '.', ',')?></th>
    <th style="background-color:#C0B9B9!important;padding:8px!important; color:#000000!important;" class="text-right" colspan="1" ><?php
    ...
    <th style="background-color:#C0B9B9!important;padding:8px!important; color:#000000!important;" class="text-right" colspan="1" ><?php
        ...
        <th class="text-right" style="background-color:#C0B9B9!important;padding:8px!important; color:#000000!important;">$<span id="allowancebalance" ><?= number_format($balance, 2, '.', ',') ?>  <?php $this->load->library('session'); $this->session->set_userdata('balanceaapd', $balance); ?> </span>  </th>
