...
?>
    <tr>
        ...
        <td class="text-right" style="text-align:right;"><?php if (isset($val['invoiced_amount'] ))
            {
...
<tr class="imth">
        <th style="background-color:#C0B9B9!important;padding:5px!important; color:black!important;" colspan="2" >TOTAL VARIATIONS</th>
        <th style="background-color:#C0B9B9!important;padding:5px!important; color:black!important;text-align:right;" ><?php echo "$";?><?php echo number_format(abs($totalvars),2,'.',',')?></th>
        <th style="background-color:#C0B9B9!important;padding:5px!important; color:black!important;"></th>
        <th style="background-color:#C0B9B9!important;padding:5px!important; color:black!important;text-align:right;">$<?= number_format($total_invoice_amount, 2, '.', ',') ?></th>
        <th style="background-color:#C0B9B9!important;padding:5px!important; color:black!important;text-align:right;">$<?= number_format($total_invoice_amount_paid, 2, '.', ',') ?></th>
        <th style="background-color:#C0B9B9!important;padding:5px!important; color:black!important;text-align:right;">$<?= number_format($total_invoice_amount_owing, 2, '.', ',') ?></th>
       
        <?php $this->load->library('session'); $this->session->set_userdata('balanceavar', $balance); ?>
        <th style="background-color:#C0B9B9!important;padding:5px!important; color:black!important;text-align:right;">$<?= number_format($balance, 2, '.', ',') ?></th>
