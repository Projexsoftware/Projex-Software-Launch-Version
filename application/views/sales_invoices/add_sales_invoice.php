                <form id="SalesInvoiceForm" method="POST" action="<?php echo SURL ?>sales_invoices/addsalesinvoice" autocomplete="off">
				                    	...
				                    	<div class="row">
                                             <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="alert alert-success">
                                                  <p><strong>Note!</strong> You are about to create sales invoice, click create to continue</p>
                                                </div>
                                                ...
                                                <div class="form-group label-floating col-md-12">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="text" name="invoice_number" value="<?= (isset($id)) ? $id + 2000000 : '0000000'; ?>" readonly>
                                                    </div>
                                                </div>
                                                <?php if($type=='var'): ?>
                                                <div class="form-group label-floating col-md-12">
                            ...
                            <div class="card">
                                <div class="card-content">
                                     <div class="form-footer">
                                         <div class="pull-left">
                                            <button type="submit" class="btn btn-success btn-fill">Create Sales Invoice</button>
                                         </div>
