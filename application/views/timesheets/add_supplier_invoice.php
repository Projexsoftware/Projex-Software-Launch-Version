 <div id='estimatewarning' class='alert alert-danger' style='display:none'>Warning: This project costing contains estimated costs.</div>
               <form id="SupplierInvoiceForm" method="POST" action="<?php echo SURL ?>supplier_invoices/insertinvoice" onsubmit="return validateForm()" autocomplete="off">
                   ...
                   <input type="hidden" name="invoice_type" id="invoice_type" value="timesheet">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                    ...
                                    <div class="card-content">
                                        <h4 class="card-title">Timesheet Supplier Invoice</h4>
				                    	<div class="row">
                                             <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group label-floating col-md-6">
                                                    <label>Project For Supplier Invoices <small>*</small></label>
                                                    <input style="margin-top:8px;" type="text" class="form-control" readonly value="<?php echo $project_title;?>">
                                                    <input type="hidden" name="project_id" id="project_id" value="<?php echo $project_id;?>">
                                                </div>
                                                <div class="form-group label-floating col-md-6">
                                                        <label>Supplier Invoice Name <small>*</small></label>
                                                           <select class="selectpicker" data-style="select-with-transition" data-live-search="true" name="first_selected_supplier" id="first_selected_supplier" title="Select Supplier" required>
                                                                <?php if(count($suppliers)>0){ 
                                                                foreach($suppliers as $val){
                                                                ?>
                                                                <option value="<?php echo $val['costing_supplier'];?>"><?php echo $val['supplier_name'];?></option>
                                                                <?php } } ?>
                                                            </select>
                                    ...
                                    <div class="row">
                                             <div class="col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                        <label>Cost Subtotal <small>*</small></label>
                                                           <input class="form-control" name="invoiceamountist" id="invoiceamountist" value="<?php echo $cost_subtotal;?>" type="text" required readonly number="true">
                                    ...
                                    <div class="row">
                                             <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group label-floating col-md-6">
                                                    ...
                                                    <input class="form-control" name="worked_hours" id="worked_hours" readonly type="text" required value="<?php echo $worked_hours;?>">
                                                </div>
                                                <div class="form-group label-floating col-md-6">
                                                        &nbsp;
                                                </div>
                                           ...
                                           <div class="table-responsive">
                                                 <table id="impcos1" class="table sortable_table templates_table">
                                                   <thead>
                                                       ...
                                                       <tr>
                                                           <td colspan="6"><span id="projecttitleimp"><?php echo $project_title;?></span></td>
                                    ...
                                    <table class="table calstable">
                                      <tbody>
                                        ...
                                        <select class="selectpicker notrequired" data-style="select-with-transition" name="supplierinvoicestatus" id="supplierinvoicestatus"  title="Select Status" required>
                                            ...
                                            ?><option disabled class="disableme" value="Approved">Approved</option>
                                            <?php } ?>
                                            <option disabled value="Paid" disabled>Paid</option>
                                            <option disabled value="Sales Invoiced">Sales Invoiced</option>
                                        </select>
                                    ...
                                    <table class="table">
                                      <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                    <textarea class="form-control notrequired" rows="5"  id="varidescriptioin" name="varidescriptioin" required="true" placeholder="Variation Description"></textarea>
                                            </td>              
                                        </tr>
                                          <tr>
                                ...
                                <div class="card-content">
                                     <div class="form-footer">
                                         ...
                                         <div class="pull-right">
                                            <a href="<?php echo SURL;?>timesheets/view/<?php echo $timesheet_id;?>" class="btn btn-warning btn-fill">Close</a>
                                      </div>
                                     </div>
                                 </div>
                            </div>
