    ...
    <div class="col-md-12">
        <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Project Unordered Items Report</h4> 
                                    <div class="toolbar">
                                        <?php
                                        ...
                                        <div class="row">
                                             <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="form-group label-floating col-md-12">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select class="selectpicker" data-style="select-with-transition" name="project_id" id="unordered_items_project_id" title="Select Project" data-live-search="true" required onchange="get_project_unordered_items();">
