...
<body class="off-canvas-sidebar">
              <div class="email-container">
                    ...
                    <div class="email-body"><h3>Order Confirmation Email</h3><p>Congrats! You have placed your order successfully.</p><a href="<?php echo SURL;?>login" class="btn_account">ACCESS ACCOUNT</a></div><div class="email-content"><h3>Hi <?php echo $firstname;?>,</h3><p>Below is the details of your order:</p><p><h4><b><?php echo "#".$order_no." <small>".date('F, d Y', strtotime($created_date))." at ".date('h:ia', strtotime($created_date));?></small></b></h4></p>
                    <h3>Order Summary</h3>
                    <p><table class="table table-bordered" >
                            ...
                            <tr> 
                                <td>
                                 <img src="<?php echo ONLINE_STORE_IMAGES.$items['image']; ?>" style="width:50px;height:50px;" width="50px" height="50px">
                                </td>
