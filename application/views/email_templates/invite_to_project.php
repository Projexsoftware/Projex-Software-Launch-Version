...
<body class="off-canvas-sidebar">
              <div class="email-container"><div class="email-header"><h2>Projex Software</h2></div><div class="email-body"><h3>Invitation</h3><p></p></div><div class="email-content"><h3>Hi <?php echo $firstname;?>,</h3><p>You have been invited to join <b><?php echo $project_name;?></b> project, <?php echo $project_description;?>.
</p><p><center><a href="<?php echo SCURL;?>join/project/<?php echo $token;?>" class="btn_account">JOIN</a></center></p><p></p><p><b>Regards</b><br/><br/><?php echo $from_username;?><br/><?php echo $from_designation;?></p></div><div class="email-footer"><div class="social-line">
