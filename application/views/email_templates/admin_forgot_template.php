    ...
    <style>
     .email-container{
      ...
      .email-body{
          ...
          height:140px;
          text-align:center;
          background-image: url(<?php echo AURL;?>assets/img/login.jpeg);
          top: 0;
          left: 0;
