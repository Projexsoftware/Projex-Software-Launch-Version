<footer class="footer notprint">
                <div class="container-fluid">
                    ...
                    <p class="copyright pull-right">
                        ...
                        <a target="_Blank" href="<?php echo SURL;?>dashboard">Launch Version</a>, Developed by Projex Software Ltd
                    </p>
                </div>
            </footer>
      ...
      <div class="modal-body" style="padding:0px;">
                                    ...
                                    <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select class="selectComponentSupplier" data-style="select-with-transition" title="Supplier *" data-live-search="true" data-size="7" name="supplier_id" id="supplier_id" required="true">
                                                    </select>
