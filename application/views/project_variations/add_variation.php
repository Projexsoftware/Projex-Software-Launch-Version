                        ...
                        <div class="col-md-12">
                            <div class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="form-group label-floating">
                								<select class="selectpicker" data-style="select-with-transition" data-live-search="true" title="Filter List Below by Stage" data-size="7" name="extstages" id="extstages" multiple="multiple" onchange="getParts(this.value, 'stage');">
                                                    
                                                </select>
                                        </div>
                                        <div class="form-group label-floating">
                								<select class="selectpicker" data-style="select-with-transition" data-live-search="true" title="Filter List Below by Supplier" data-size="7" name="extsuppliers" id="extsuppliers" multiple="multiple" onchange="getParts(this.value, 'supplier');">
