...
<table id="tablepo<?php echo $counter; ?>" class="table table-no-bordered templates_table">
        ...
        <tbody>
            ...
            $updated_quantity = get_recent_quantity($oi['costing_part_id']);
            if(count($updated_quantity)>0 && $updated_quantity['updated_quantity']>0){
                //$ordered_quantity = $oi['order_quantity']-$supplier_ordered_quantity;
                $ordered_quantity = $supplier_ordered_quantity;
                $uninvoicedquantity = $updated_quantity['updated_quantity'] - $ordered_quantity;
            
            }
            else  if(count($updated_quantity)>0 && $updated_quantity['updated_quantity']==0){
                $uninvoicedquantity = $updated_quantity['updated_quantity'];
            }
            else{
            ...
            <tr class="locked pocos<?php echo $counter; ?>" to_val="<?php echo $counter; ?>">
                ...
                <td>
                    <input  type="hidden" name="<?= 'pcuom[]' ?>" id="pouomfield<?php echo $counter ?>" rno ='<?php echo $counter ?>' value="<?php echo $oi['costing_uom'] ?>" class="form-control" width="5" />
                    <?php echo $oi['costing_uom'];?>
                </td>
                 <td>
        ...
        <tbody>
            ...
            <tr id="tablepc<?php echo $counter; ?>trnumber<?php echo $counter ?>" class="locked prcos<?php echo $counter; ?>" ta_val="<?php echo $counter; ?>" tr_val="<?php echo $counter ?>">
                ...
                <input type="hidden" name="<?= 'pcinvoicetype[]' ?>" value="pc">
                    ...
                    <td><input  type="hidden" name="<?= 'pcuom[]' ?>" id="uomfield<?php echo $counter ?>" rno ='<?php echo $counter ?>' value="<?php echo $pts->costing_uom ?>" class="form-control" width="5" /><?php echo $pts->costing_uom ?></td>
                    
                    <td>
                        <input  type="hidden" name="<?= 'pcucost[]' ?>" id="pcinuccost<?php echo $counter ?>" rno ='<?php echo $counter ?>' class="form-control" value="<?php echo $pts->costing_uc ?>" onchange="calculateTotal(this.getAttribute('rno'))"/><?php echo number_format($pts->costing_uc, 2, '.', ''); ?>
                    ...
                    <td><input type="hidden" name="<?= 'uninvoicequantity[]' ?>" id="pcuninvoicequantity<?php echo $counter ?>" value="<?php echo $uninvoicedquantity; ?>" rno ='<?php echo $counter ?>' class="form-control" /><?php echo $uninvoicedquantity; ?></td>
                    
                    <td><input disabled type="hidden" name="<?= 'uninvoicebudget[]' ?>" id="pcuninvoicebudget<?php echo $counter ?>" value="<?php echo $pts->uninvoicebudget; ?>" rno ='<?php echo $counter ?>' class="form-control" /><?php echo number_format($pts->costing_uc*($uninvoicedquantity), 2, '.', ''); ?></td>
                    ...
                    <td><input  type="text" name="<?= 'pcinvoicecostdiff[]' ?>" id="pcinvoicecostdiff<?php echo $counter ?>" ty='pc' rno ='<?php echo $counter ?>' readonly <?php if($pts->client_allowance==1){ ?> value="allowance" class="form-control readonlyme" <?php } else{ ?>value="<?php echo "0.00"; ?>" class="form-control  invoicedifference readonlyme" <?php } ?>/></td>
