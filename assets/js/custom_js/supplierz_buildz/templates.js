...
$.validator.addMethod('uniqueTemplate', function(value) {
         ...
         var result = $.ajax({ 
			    ...
			    async:false, 
                url:base_url + 'supplierz_buildz/templates/verify_name',
                type: 'post',
			    data:{name: value},
	}); 
...
$('.add_new_task').click(function(){
    ...
    if($("#TaskForm").valid()){
          ...
          $.ajax({
                type:'POST',
                url:base_url+'supplierz_buildz/templates/add_new_template_item',
                data: data,
...
function get_stage_status(template_id, stage_id){
    ...
    $.ajax({
                type:'POST',
                url:base_url+'supplierz_buildz/templates/get_stage_status',
...
function get_template_items(){
          ...
          $.ajax({
                type:'POST',
                url:base_url+'supplierz_buildz/templates/get_template_items',
   ...
   stop : function(event, ui){
     ...
     $.ajax({
                type:'POST',
                url:base_url+'supplierz_buildz/templates/sort_stages',
...
$(document).on('click','.remove_task',function(){
          ...
          swal({
                ...
                $.ajax({
                   type:'POST',
                   url:base_url+'supplierz_buildz/templates/remove_task',
...
if(total_checkboxes == checklist_count){
 ...
 status = 0;
          ...
          $.ajax({
                type:'POST',
                url:base_url+'supplierz_buildz/templates/update_task_checklist',
...
$(document).on('click','.add_new_checklist',function(){
	 ...
	 var item_id = $("#checklistForm"+rowno+" #checklist_item_id").val();			
         var result = $.ajax({ 
			    ...
			    async:false, 
                url:base_url + 'supplierz_buildz/templates/verify_checklist',
                type: 'post',
    ...
    if(result.responseText == '0') return true; else return false;
          ...
          $.ajax({
                type:'POST',
                url:base_url+'supplierz_buildz/templates/add_new_checklist',
...
$(document).on('click','.add_new_note',function(){
          ...
          $.ajax({
                type:'POST',
                url:base_url+'supplierz_buildz/templates/add_new_note',
...
$(document).on('click','.remove_note',function(){
          ...
          swal({
                ...
                $.ajax({
                   type:'POST',
                   url:base_url+'supplierz_buildz/templates/remove_note',
                   data: {id:id},
                   success:function(result){
                       swal({
                        title: "Note Deleted!",
...
$(document).on('click','.remove_checklist',function(){
          ...
          swal({
                ...
                $.ajax({
                   type:'POST',
                   url:base_url+'supplierz_buildz/templates/remove_checklist',
...
$(document).on('submit','.upload_task_file',function(e){
    ...
    $.ajax({
                ...
                url: base_url+'supplierz_buildz/templates/upload_file', 
                type: "POST",            
...
$(document).on('click','.remove_file',function(){
          ...
          swal({
                ...
                $.ajax({
                   type:'POST',
                   url:base_url+'supplierz_buildz/templates/remove_file',
                   data: {id:id,template_id:template_id,rowno:rowno},
                   success:function(result){
                       swal({
                        title: "File Deleted!",
...
$(document).on('submit','.upload_task_image',function(e){
    ...
    $.ajax({
                ...
                url: base_url+'supplierz_buildz/templates/upload_image', 
                type: "POST",            
                data: new FormData(this), 
                contentType: false,       
                cache: false,             
...
$(document).on('click','.remove_image',function(){
          ...
          swal({
                ...
                $.ajax({
                   type:'POST',
                   url:base_url+'supplierz_buildz/templates/remove_image',
                   data: {id:id,template_id:template_id,rowno:rowno},
                   success:function(result){
                       swal({
                        title: "Image Deleted!",
...
$(document).on('click','.add_new_reminder',function(){
	  ...
	  var task_id = $('#task_id'+rowno).val();
          ...
          var result = $.ajax({ 
			    ...
			    async:false, 
                url:base_url + 'supplierz_buildz/reminder_users/verify_email',
                type: 'post',
    ...
    if(result.responseText == '0') return true; else return false;
	  ...
	  setFormValidation('#RemindersForm'+rowno);
          ...
          $.ajax({
                type:'POST',
                url:base_url+'supplierz_buildz/templates/add_new_reminder',
...
$(document).on('click','.remove_reminder',function(){
          ...
          swal({
                ...
                $.ajax({
                   type:'POST',
                   url:base_url+'supplierz_buildz/templates/remove_reminder',
                   data: {id:id},
                   success:function(result){
                       swal({
...
$(document).on('change','#message_id',function(){
        ...
        $.ajax({
                   type:'POST',
                   url:base_url+'supplierz_buildz/projects/get_reminder_message',
                   data: {id:id},
                   beforeSend: function(){
...
function renumber_table(tableID) {
	$(tableID + " tr").each(function() {
		...
		$(this).find('.priority').html(count);
                $.ajax({
                type:'POST',
                url:base_url+'supplierz_buildz/templates/sort_item',
...
$('body').on('click', '.available_for_import_by_user', function(){
        var available_for_import_by_user = $(this).prop("checked") == true ? 1 : 0;
        var id = $(this).val();
        var current = $(this);
        if(available_for_import_by_user == 0){
            swal({
                title: 'Are you sure?',
                ...
                $.ajax({
                type:'POST',
                url:base_url+'supplierz_buildz/templates/available_for_import_by_user',
                data: {id:id,available_for_import_by_user:available_for_import_by_user},
                success:function(result){
                    if(available_for_import_by_user == 1){
                      swal({
                           title: 'Template is available for import by User!',
                           text: 'The selected template will be available for users.',
                           type: 'success',
                           confirmButtonClass: "btn btn-success",
                           buttonsStyling: false
                        });
                        ...
                        swal({
                           title: 'Template is not available for import by User!',
                           text: 'The selected template will not be available for Users. You can allow it back anytime if needed.',
                           type: 'success',
                           confirmButtonClass: "btn btn-success",
                           buttonsStyling: false
                        });	
...
$(document).on('change','.import_template_from_supplierz_buildz_template',function(){
          ...
          $.ajax({
                type:'POST',
                url:base_url+'supplierz_buildz/templates/import_template_from_supplierz_buildz_template',
