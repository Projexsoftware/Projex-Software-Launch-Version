...
$.validator.addMethod('uniqueTemplate', function(value) {
         ...
         var result = $.ajax({ 
			    ...
			    async:false, 
                url:base_url + 'scheduling/templates/verify_name',
                type: 'post',
			    data:{name: value},
	}); 
    ...
    $(document).ready(function() {
        ...
        $('.editable').on('click', function() {
                ...
                inputField.on('blur', function() {
                    ...
                    $.ajax({
                        type:'POST',
                        url:base_url+'scheduling/templates/update_template_info',
                        data: {id:id,value:newText,type:type},
                        success:function(response){
                            if(response != "error"){
                               $('#editable-'+type).text(newText);
                               toastr.success(response, 'Success');
                            }
                            else{
                                toastr.error('Template name already exists!', 'Error');
                            }
                        }
                    }); 
                    $(this).remove(); // Remove the input field
                    $('#editable-'+type).show(); // Show the paragraph again
                });
...
$('.add_new_task').click(function(){
    ...
    if($("#TaskForm").valid()){
          ...
          $.ajax({
                type:'POST',
                url:base_url+'scheduling/templates/add_new_template_item',
                data: data,
...
function get_stage_status(template_id, stage_id){
    ...
    $.ajax({
                type:'POST',
                url:base_url+'scheduling/templates/get_stage_status',
...
function get_template_items(){
          ...
          $.ajax({
                type:'POST',
                url:base_url+'scheduling/templates/get_template_items',
   ...
   stop : function(event, ui){
     ...
     $.ajax({
                type:'POST',
                url:base_url+'scheduling/templates/sort_stages',
...
$(document).on('click','.remove_task',function(){
          ...
          swal({
                ...
                $.ajax({
                   type:'POST',
                   url:base_url+'scheduling/templates/remove_task',
...
if(total_checkboxes == checklist_count){
 ...
 status = 0;
          ...
          $.ajax({
                type:'POST',
                url:base_url+'scheduling/templates/update_task_checklist',
...
$(document).on('click','.add_new_checklist',function(){
	 ...
	 var item_id = $("#checklistForm"+rowno+" #checklist_item_id").val();			
         var result = $.ajax({ 
			    ...
			    async:false, 
                url:base_url + 'scheduling/templates/verify_checklist',
                type: 'post',
    ...
    if(result.responseText == '0') return true; else return false;
          ...
          $.ajax({
                type:'POST',
                url:base_url+'scheduling/templates/add_new_checklist',
...
$(document).on('click','.add_new_note',function(){
          ...
          $.ajax({
                type:'POST',
                url:base_url+'scheduling/templates/add_new_note',
...
$(document).on('click','.remove_note',function(){
          ...
          swal({
                ...
                $.ajax({
                   type:'POST',
                   url:base_url+'scheduling/templates/remove_note',
                   data: {id:id},
                   success:function(result){
                       swal({
                        title: "Note Deleted!",
...
$(document).on('click','.remove_checklist',function(){
          ...
          swal({
                ...
                $.ajax({
                   type:'POST',
                   url:base_url+'scheduling/templates/remove_checklist',
...
$(document).on('submit','.upload_task_file',function(e){
    ...
    $.ajax({
                ...
                url: base_url+'scheduling/templates/upload_file', 
                type: "POST",            
...
$(document).on('click','.remove_file',function(){
          ...
          swal({
                ...
                $.ajax({
                   type:'POST',
                   url:base_url+'scheduling/templates/remove_file',
                   data: {id:id,template_id:template_id,rowno:rowno},
                   success:function(result){
                       swal({
                        title: "File Deleted!",
...
$(document).on('submit','.upload_task_image',function(e){
    ...
    $.ajax({
                ...
                url: base_url+'scheduling/templates/upload_image', 
                type: "POST",            
                data: new FormData(this), 
                contentType: false,       
                cache: false,             
...
$(document).on('click','.remove_image',function(){
          ...
          swal({
                ...
                $.ajax({
                   type:'POST',
                   url:base_url+'scheduling/templates/remove_image',
                   data: {id:id,template_id:template_id,rowno:rowno},
                   success:function(result){
                       swal({
                        title: "Image Deleted!",
...
$(document).on('click','.add_new_reminder',function(){
    ...
    if(result.responseText == '0') return true; else return false;
	  ...
	  setFormValidation('#RemindersForm'+rowno);
          ...
          $.ajax({
                type:'POST',
                url:base_url+'scheduling/templates/add_new_reminder',
...
$(document).on('click','.remove_reminder',function(){
          ...
          swal({
                ...
                $.ajax({
                   type:'POST',
                   url:base_url+'scheduling/templates/remove_reminder',
                   data: {id:id},
                   success:function(result){
                       swal({
...
function renumber_table(tableID) {
	$(tableID + " tr").each(function() {
		...
		$(this).find('.priority').html(count);
                $.ajax({
                type:'POST',
                url:base_url+'scheduling/templates/sort_item',
...
$(document).on('change','.import_template_from_project',function(){
          ...
          $.ajax({
                type:'POST',
                url:base_url+'scheduling/templates/import_template_from_project',
                data: {import_project_id:import_project_id,template_id:template_id},
                success:function(result){
                       get_template_items();
                       swal({
...
$(document).on('change','.import_template_from_template',function(){
          var import_template_id = $(this).val();
          var template_id = $("#template_id").val();
          var template_name = $("#import_template_id option:selected").text();
          if(import_template_id!=""){
          $.ajax({
                type:'POST',
                url:base_url+'scheduling/templates/import_template_from_template',
                data: {import_template_id:import_template_id,template_id:template_id},
                success:function(result){
                       get_template_items();
                       swal({
                       ...
                       $("#import_template_id").val('default');
                       $("#import_template_id").selectpicker("refresh");
                }
             }); 
           }
});

$(document).on('change','.import_template_from_supplierz_buildz_template',function(){
          var import_supplierz_buildz_template_id = $(this).val();
          var template_id = $("#template_id").val();
          var template_name = $("#import_supplierz_buildz_template_id option:selected").text();
          if(import_supplierz_buildz_template_id!=""){
          $.ajax({
                type:'POST',
                url:base_url+'scheduling/templates/import_template_from_supplierz_buildz_template',
                data: {import_template_id:import_supplierz_buildz_template_id,template_id:template_id},
                success:function(result){
                       get_template_items();
                       swal({
                        title: template_name +"'s Template Items Imported!",
                       ...
                       $("#import_supplierz_buildz_template_id").val('default');
                       $("#import_supplierz_buildz_template_id").selectpicker("refresh");
                }
             }); 
           }
});