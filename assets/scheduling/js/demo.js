demo = {
    ...
    showSwal: function(type, controller_name, id) {
        if (type == 'basic') {
            swal({
...
$('.nav a[data-toggle="collapse"]').click(function(){
  $('.nav a[data-toggle="collapse"]').addClass("collapsed");
  $('.nav a[data-toggle="collapse"]').attr("aria-expanded", false); 
  $('.nav div.collapse').removeClass("in"); 
